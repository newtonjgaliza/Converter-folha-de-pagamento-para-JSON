...
def index():
    if request.method == "POST":
        ...
        if file and file.filename.lower().endswith(".pdf"):
            ...
            #versao antiga\
            #return render_template("success.html", filename=json_filename)
            json_text = json.dumps(dados, indent=2, ensure_ascii=False)
            return render_template("success.html", filename=json_filename, json_data=json_text)
